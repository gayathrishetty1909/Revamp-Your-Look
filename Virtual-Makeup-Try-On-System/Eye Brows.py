...
# mask
# Left
browmask = np.zeros_like(img)
browimg = cv2.fillPoly(browmask, [landmarkspints[17:20]],(255,255,255))
browimg2 = cv2.fillPoly(browmask, [landmarkspints[19:22]],(255,255,255))

#Right
browimg3 = cv2.fillPoly(browmask, [landmarkspints[22:25]],(255,255,255))
browimg4 = cv2.fillPoly(browmask, [landmarkspints[24:27]],(255,255,255))

cv2.imshow("brow",browimg)  
...
# lip colours
browimgcolor = np.zeros_like(browimg)
...
while True:
    ...
    #255,248,220
    browimgcolor[:] = b,g,r
    browimgcolor = cv2.bitwise_and(browimg,browimgcolor)
    #lip edges charpe to blur
    browimgcolor = cv2.GaussianBlur(browimgcolor,(5,5),5)
    #add to og image
    finalmakeup = cv2.addWeighted(finalimage,1,browimgcolor, 1,0)
